...
namespace WindowsFormsApp
{
    public class MainForm : Form
    {
        ...
        private WordToHtmlConverter wordConverter;
        ...
        {
            InitializeComponent();
            wordConverter = new WordToHtmlConverter();
        ...
        private void btnSaveToDb_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                currentHtmlContent = wordConverter.ConvertToHtmlString(currentFilePath);
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            var doc = (Documents)dgvDocuments.SelectedRows[0].DataBoundItem;
        ...
        private void btnRefactor_Click(object sender, EventArgs e)
        {
            if (dgvDocuments.SelectedRows.Count == 0)
            {
                MessageBox.Show("Vui lòng chọn tài liệu để xem.");
                return;
            }
            ...
            try
            {
                ...
                // Đường dẫn file HTML
                string htmlFileName = doc.Title + "_show.html";
                string tempHtmlPath = Path.Combine(folderPath, htmlFileName);

                // Tạo nội dung HTML
                string htmlContent = HtmlMerge.GenerateFromEntities(doc.DocumentId);
            ...
            {
                MessageBox.Show("Lỗi khi hiển thị tài liệu: " + ex.Message);
            }
        }
    }
}
